...
<CheckboxPrimitive.Root
	...
	data-slot="checkbox"
	class={cn(
		'peer relative flex size-6 shrink-0 items-center justify-center rounded-none border border-input shadow-xs transition-shadow outline-none group-has-disabled/field:opacity-50 after:absolute after:-inset-x-3 after:-inset-y-2 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-20 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 aria-invalid:aria-checked:border-primary dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 data-checked:border-base-content data-checked:bg-base-content data-checked:text-base-100 dark:data-checked:bg-base-content',
		className
	)}
	bind:checked
	bind:indeterminate
